import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,f as n,e as t,a as i,o as l}from"./app-C49dgTjO.js";const r={};function o(h,s){return l(),a("div",null,[s[0]||(s[0]=n('<h1 id="从http迁移到https" tabindex="-1"><a class="header-anchor" href="#从http迁移到https"><span>从HTTP迁移到HTTPS</span></a></h1><hr><h3 id="迁移总览-六个核心步骤" tabindex="-1"><a class="header-anchor" href="#迁移总览-六个核心步骤"><span>迁移总览：六个核心步骤</span></a></h3><p>一个标准的HTTP到HTTPS的迁移流程可以概括为以下六个步骤：</p><ol><li><strong>获取SSL证书</strong></li><li><strong>在服务器上安装和配置SSL证书</strong></li><li><strong>将网站所有流量从HTTP 301重定向到HTTPS</strong></li><li><strong>解决“混合内容”问题</strong></li><li><strong>更新所有外部服务和引用</strong></li><li><strong>验证和监控</strong></li></ol><hr><h3 id="步骤一-获取ssl证书" tabindex="-1"><a class="header-anchor" href="#步骤一-获取ssl证书"><span>步骤一：获取SSL证书</span></a></h3>',7)),t(` 
**1. 选择证书类型：**
